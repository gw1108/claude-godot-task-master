...
Replace `[FULL_FILE_PATH]` with the absolute path printed by `create_thought.py`. Assumptions and open questions belong inside the document itself, and the user can run `/iterate_research_codebase [research-doc-path]` if they want follow-ups.
